...
def fold(p1, p2, p3, ra, rb, rc):
    ...
    n2 = diffvector(p2, p3)
    if n1[1] == 0:
        p1, p2, p3, ra, rb, rc = p1, p3, p2, ra, rc, rb
        n1 = diffvector(p1, p2)
        n2 = diffvector(p2, p3)
    ...
    r1 = (A*n2[1] - B*n1[1])/(n1[0]*n2[1] - n2[0]*n1[1])
...
pos = fold(p1, p2, p3, ra, rb, rc)
# br = bridge(p1, p2, ra, rb)
...
print(f'{pos[0]:20.16f}{pos[1]:20.16f}{pos[2]:20.16f}')
